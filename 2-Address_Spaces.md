...
The formats of multiple byte data types in memory are given in [Figure 2-4](#figure-2-4-formats-of-multiple-byte-data-elements-in-memory).
...
<a id="figure-2-4-formats-of-multiple-byte-data-elements-in-memory"></a>
