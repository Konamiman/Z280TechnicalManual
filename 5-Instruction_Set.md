...
This section presents an overview of the Z280 instruction set, arranged by functional groups. (See [Section 5.5](#55-notation-and-binary-encoding) for an explanation of the notation used in Tables 5-2 through 5-11.)
